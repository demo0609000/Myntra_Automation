...
//		}
		...
		driver.manage().timeouts().pageLoadTimeout(Utils.TestUtil.PAGE_LOAD_TIMEOUT, TimeUnit.SECONDS);
		driver.manage().timeouts().implicitlyWait(Utils.TestUtil.IMPLICIT_WAIT, TimeUnit.SECONDS);
